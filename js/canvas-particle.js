var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		var qq =document.getElementById("body_particle");
		// console.log(qq);
		qq.appendChild(canvasObj);
	...
	function canvasSize(canvas){
		...
		canvas.width = document.getElementById("body_particle").clientWidth;
		canvas.height = document.getElementById("body_particle").clientHeight;
	}
